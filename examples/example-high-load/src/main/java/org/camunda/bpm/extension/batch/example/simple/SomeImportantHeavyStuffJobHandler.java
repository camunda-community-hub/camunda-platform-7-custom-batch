...
public class SomeImportantHeavyStuffJobHandler extends CustomBatchJobHandler<String> {

  private static final Logger logger = LoggerFactory.getLogger(SomeImportantHeavyStuffJobHandler.class.getSimpleName());

  public static final String TYPE = "high-load-batch-handler";

...
The Release 1.20.2 will be the last one.
...
With this extension it will be much easier to create an own batch.
...
A new batch is created with help of the `CustomBatchBuilder` and a specific `BatchJobHandler` for a set of batch data.

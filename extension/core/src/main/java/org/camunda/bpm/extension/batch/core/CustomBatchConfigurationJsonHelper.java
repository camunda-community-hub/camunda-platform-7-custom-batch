...
public class CustomBatchConfigurationJsonHelper<T> implements CustomBatchConfigurationHelper<T> {
  ...
  public static <T> CustomBatchConfigurationJsonHelper<T> of(final JsonObjectConverter<CustomBatchConfiguration<T>> converter) {

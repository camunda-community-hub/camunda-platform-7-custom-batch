...
*ATTENTION:* Currently this extension is not compatible to camunda 7.13! See Issue _https://github.com/camunda/camunda-bpm-custom-batch/issues/29[#29]_
...
```
compile("org.camunda.bpm.extension.batch:camunda-bpm-custom-batch-core:1.4.0")
```

...
image::https://github.com/camunda-community-hub/camunda-bpm-custom-batch/actions/workflows/build.yml/badge.svg[link="https://github.com/camunda-community-hub/camunda-bpm-custom-batch/actions/workflows/build.yml"]
// license
...
```kotlin
compile("org.camunda.bpm.extension.batch:camunda-bpm-custom-batch-core:1.5.2")
```
